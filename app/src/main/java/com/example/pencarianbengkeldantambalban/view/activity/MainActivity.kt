package com.example.pencarianbengkeldantambalban.view.activity
...
import com.example.pencarianbengkeldantambalban.view.adapter.MainAdapter
import com.example.pencarianbengkeldantambalban.viewmodel.MainViewModel
...
class MainActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    var permissionArrays = arrayListOf(Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION)
    ...
    private fun requestPermissions(permissionArrays: ArrayList<String>, i: Int) {
    ...
    private fun getLocationViewModel() {
        ...
        progressDialog.show()
        mainViewModel.getMarkerLocation().obsers(this, { modelResults: ArrayList<ModelResults?> ->
